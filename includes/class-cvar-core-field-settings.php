 ...
 * @since 0.1.0
 */
class CVAR_Field_Settings {

    /**
     * The single instance of CVAR_Field_Settings.
     * @var     object
     * @access  private
     * @since   1.0.0
     */
    ...
    function relate_articles_to_issues () {
        ...
        p2p_register_connection_type( array(
            ...
            'title'         => array(
                'from'      => __( 'Issue', 'cvar-core' ),
                'to'        => __( 'Articles in this Issue', 'cvar-core' )
            ),
            'from_labels'   => array(
                'singular_name' => __( 'Article', 'cvar-core' ),
                'search_items'  => __( 'Search articles', 'cvar-core' ),
                'not_found'     => __( 'No articles found.', 'cvar-core' ),
                'create'        => __( 'Add Article', 'cvar-core' ),
            ),
            'to_labels'         => array(
                'singular_name' => __( 'Issue', 'cvar-core' ),
                'search_items'  => __( 'Search issues', 'cvar-core' ),
                'not_found'     => __( 'No issues found.', 'cvar-core' ),
                'create'        => __( 'Add to Issue', 'cvar-core' ),
            ),
            'admin_column'      => true,
            'admin_dropdown'    => 'any',
            'sortable'          => 'any',
        ...
        p2p_register_connection_type( array(
            ...
            'title'         => array(
                'from'      => __( 'Featured in Issue', 'cvar-core' ),
                'to'        => __( 'Featured Article', 'cvar-core' )
            ),
            'from_labels'   => array(
                'singular_name' => __( 'Article', 'cvar-core' ),
                'search_items'  => __( 'Search articles', 'cvar-core' ),
            ...
            'to_labels'         => array(
                ...
                'search_items'  => __( 'Search issues', 'cvar-core' ),
                'not_found'     => __( 'No issues found.', 'cvar-core' ),
                'create'        => __( 'Add Featured Article', 'cvar-core' ),
            ),
            'admin_column'      => true,
            'admin_dropdown'    => 'any',
            'sortable'          => 'any',
